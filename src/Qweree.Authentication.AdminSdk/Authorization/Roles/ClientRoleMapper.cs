...
public static class ClientRoleMapper
{
    ...
    {
        return new ClientRole(dto.Id ?? Guid.Empty, dto.Key ?? string.Empty, dto.Label ?? string.Empty,
    ...
    {
        return new ClientRoleCreateInputDto
        {
            Id = input.Id,
    ...
    {
        return new ClientRoleModifyInputDto
        {
            Description = input.Description,
            Items = input.Items?.ToArray(),
            IsGroup = input.IsGroup,

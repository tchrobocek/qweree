...
namespace Qweree.AspNet.Application
{
    ...
    public class Response
    {
        ...
        {
            return new(ResponseStatus.Ok, null, Array.Empty<Error>());
        }

        public static Response Ok(object payload)
        {
            return new(ResponseStatus.Ok, payload, Array.Empty<Error>());
        }
        ...
        {
            return new(ResponseStatus.Ok, payload, Array.Empty<Error>(), documentCount);
        }

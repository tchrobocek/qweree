...
namespace Qweree.Authentication.WebApi.Test.Fixture
{
    public class UserRoleRepositoryMock : IUserRoleRepository
    {
        ...
        public Task<IEnumerable<UserRole>> FindAsync(CancellationToken cancellationToken = new CancellationToken())
        {
        ...
        public Task<UserRole> GetAsync(Guid id, CancellationToken cancellationToken = new CancellationToken())
        {
            return Task.FromResult(GetRoles().First(r => r.Id == id));
        }

        public Task InsertAsync(UserRole document, CancellationToken cancellationToken = new CancellationToken())
        {
            throw new NotImplementedException();
        }

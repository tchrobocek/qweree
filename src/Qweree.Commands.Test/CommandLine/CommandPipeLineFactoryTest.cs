    ...
    public class CommandPipeLineFactoryTest
    {
        ...
        public void TestCommandPipeline()
        {
            var expectedPipeLine = new List<CommandCall>
            {
                ...
                new("command1 command2 command3", new[]{new CommandCallOption("-f", ImmutableArray<string>.Empty)}.ToImmutableArray()),
                new("command1 command2 command3 command4", new[]{new CommandCallOption("-a", ImmutableArray<string>.Empty), new CommandCallOption("-s", ImmutableArray<string>.Empty), new CommandCallOption("-d", ImmutableArray<string>.Empty), new CommandCallOption("-f", ImmutableArray<string>.Empty)}.ToImmutableArray())
            };
